...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'https://github.com/DevilWang/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'DevilWang' => 'wyc402581264@163.com' }
  s.source           = { :git => 'https://github.com/DevilWang/BlinkingLabel.git', :tag => s.version.to_s }
